...
[<https://archive.ics.uci.edu/ml/datasets/cardiotocography>](https://archive.ics.uci.edu/ml/datasets/cardiotocography){.uri}.
...
```{r}
set.seed(1337)
exp_design_b <- NA # <--- YOUR CODE HERE --->
...
```{r}
set.seed(1337)
exp_design_c <- NA # <--- YOUR CODE HERE --->
...
```{r}
ctg_data_ext <- NA # <--- YOUR CODE HERE --->
...
```{r}
train_sets_f NA # <--- YOUR CODE HERE --->
test_sets_f <- NA # <--- YOUR CODE HERE --->
```

```{r}
exp_design_f <- NA # <--- YOUR CODE HERE --->
exp_design_f$instantiate(NA # <--- YOUR CODE HERE --->
                         )
...
|   |              | HP)       |                                   |           |
+===+==============+===========+===================================+===========+
| A | 10-fold CV\  | 10        | expected AUC when training models |           |
|   |              |           | based on 90% of sample size       |           |
+---+--------------+-----------+-----------------------------------+-----------+
| B | 5- fold CV\  |           |                                   |           |
+---+--------------+-----------+-----------------------------------+-----------+
| C | 5-fold CV\   |           |                                   |           |
